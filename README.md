...
--set-env-vars "project_id=rg-trd077-pro,enterprise_reservation_name=mini-reservation-size,reservation_location=europe-west1,response_gemini_model=gemini-2.5-flash,keywords_gemini_model=gemini-2.5-flash-lite"
